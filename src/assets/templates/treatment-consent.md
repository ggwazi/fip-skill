...
Your cat has been diagnosed with Feline Infectious Peritonitis (FIP). We recommend treatment with GS-441524, an antiviral medication.

### Treatment Details

- **Medication:** GS-441524
- **Initial Dose:** _______ mg/kg daily
- **Route:** Subcutaneous injection
- **Duration:** Minimum 12 weeks (84 days)
- **Estimated Start Date:** _______________

### Success Rate & Prognosis

- Overall success rate: >85% with proper protocol
- Success rates vary by disease form:
  - Wet/Dry FIP (no CNS/ocular): 85-95%
  - Ocular FIP: 70-85%
  - Neurological FIP: 60-70%
...
- **Total Estimate: $_____________**

*Actual costs may vary based on weight gain and treatment response*

### Monitoring Plan

- Weekly check-ins
- Bloodwork at weeks 4, 8, and 12
...
- Weight gain will require dose adjustments
- Some cats may need extended treatment

### Questions & Concerns

I have had the opportunity to ask questions, and my concerns have been addressed.
...
- Complete the full treatment course unless advised otherwise
...
**Veterinary Clinic:** _______________________________________________
**Emergency Phone:** _______________________________________________
**After-Hours Emergency:** _______________________________________________

---

*This form documents informed consent for FIP treatment. Keep a copy for your records.*
